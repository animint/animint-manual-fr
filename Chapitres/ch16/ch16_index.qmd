...
<!-- comment -->
Commençons par zoomer sur un signal :
...
Le graphique ci-dessus montre en vert les modèles de segmentation de vraisemblance maximale (de un à six segments).
<!-- comment -->
...
<!-- comment -->
Nous traçons ci-dessous cet intervalle en fonction d'une fonctionnalité des données (logarithme du nombre de points de données) :
