...
<!-- comment -->
- ajout d'une légende de type de ligne pour distinguer les taux d'erreur des modèles de Bayes et de KNN.
<!-- comment -->
...
<!-- comment -->
Créez une refonte qui inclut un nouveau graphique ou une nouvelle facette pour sélectionner `validation.fold`, et un graphique de l'espace des fonctionnalités avec facettes (une facette pour l'ensemble de données d'entrainement, une facette pour l'ensemble de données de validation).
