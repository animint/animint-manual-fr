...
Ce chapitre explique `clickSelects` , l'un des deux principaux mots-clés introduits par `animint2` pour la conception de visualisations de données interactives.
<!-- comment -->
