...
Ce chapitre explique `clickSelects`, l'un des deux principaux mots-clés introduits par `animint2` pour la visualisation interactive de données.
<!-- comment -->
...
<!-- comment -->
Notez que `animint2` rend automatiquement chaque légende discrète interactive, vous n'avez donc pas besoin de spécifier explicitement `clickSelects=region`  pour la légende.
<!-- comment -->
