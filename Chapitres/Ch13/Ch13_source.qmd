...
Ci-dessous, nous calculons la perte pour plusieurs valeurs d'étiquettes, en utilisant la méthode [Liste de tableau de données](../Ch99/Ch99-appendix.html#list-of-data-tables).
