...
<!-- comment -->
- Nous expliquons ensuite la méthode à préférer pour définir un `animint` avec de nombreux sélecteurs, en utilisant des `clickSelects` et `showSelected` nommés.
<!-- comment -->
