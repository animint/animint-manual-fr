...
This chapter explains how to use [named clickSelects/showSelected variables](../Ch06/Ch06-other.html#data-driven-selectors) for creating data-driven selector names.
<!-- comment -->
...
<!-- comment -->
- We then explain the preferred method for defining an animint with many selectors, using named clickSelects/showSelected.
<!-- comment -->
...
The example data come from the [PeakSegJoint package](https://github.com/tdhock/PeakSegJoint).
<!-- comment -->
...
Note the timing of the code above.
<!-- comment -->
It takes a long time just to evaluate the R code that defines this data viz, since it has so many geoms.
<!-- comment -->
...
Note that the compilation also takes a long time, since there are so many geoms.
<!-- comment -->
The data viz can be viewed on [Ch14-for/index.html](../Ch14/Ch14-for/index.html).
<!-- comment -->
...
In this section we use named clickSelects/showSelected to create a more efficient version of the previous data visualization.
<!-- comment -->
...
It is clear that it takes much less time to evaluate the R code above which uses the named clickSelects/showSelected.
<!-- comment -->
We compile it below.
...
The animint produced above can be viewed on [Ch14-named/index.html](../Ch14/Ch14-named/index.html).
<!-- comment -->
Note that it should appear to be the same as the other data viz above.
<!-- comment -->
The timings above show that named clickSelects/showSelected are much faster than for loops, in both the definition and compilation steps.
...
<!-- comment -->
It is clear that named clickSelects/showSelected are more efficient in both respects, and should be used instead of for loops.
...
Next, [Chapter 15](../Ch15/Ch15-Newton.html) explains how to visualize root-finding algorithms.
