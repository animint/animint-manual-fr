...
# Chapitre 8, visualisation des données de la Banque mondiale
...
Le tableau ci-dessus montre qu'il y a trois lignes avec des valeurs manquantes pour la variable population.
<!-- comment -->
...
<!-- comment -->
Nous utilisons `scales="free"` et masquons les étiquettes des axes, dans un exemple de [l'idiome addColumn then facet](Ch99-appendix.html#addColumn-then-facet) .
<!-- comment -->
À la place, nous utilisons le libellé de la facette pour indiquer la variable encodée sur chaque axe.
<!-- comment -->
...
Ensuite, le [chapitre 9](Ch09-Montreal-bikes.html) explique comment visualiser les données sur les vélos à Montréal.
