...
Dans ce chapitre, nous allons explorer plusieurs visualisations des données de l'agrégation (groupe) par K-moyennes, un algorithme d'apprentissage non supervisé.
...
<!-- comment -->
- faites varier la largeur du segment en fonction de son optimalité (le segment connecté au centre de l'agrégation la plus proche devrait être mis en évidence par une largeur plus élevée).
