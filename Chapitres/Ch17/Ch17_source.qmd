...
<!-- comment -->
- Nous choisissons trois points de données aléatoires à utiliser comme centres d'agrégation.
<!-- comment -->
- Nous montrons comment toutes les distances entre les points de données et les centres d'agrégation peuvent être calculées et visualisées.
<!-- comment -->
...
Dans la visualisation des données ci-dessus, vous pouvez cliquer sur un point de données pour afficher les distances entre ce point de données et chaque centre d'agrégation.
...
<!-- comment -->
- modifiez la couleur de chaque segment pour qu'elle corresponde à l'agrégation correspondante.
<!-- comment -->
...
<!-- comment -->
- Ajoutez des transitions graduelles.
<!-- comment -->
- Ajoutez une animation sur la variable d'itération.
<!-- comment -->
- Le code actuel a un nombre maximum d'itérations fixe, il est donc possible que les dernières itérations ne progressent pas.
<!-- comment -->
...
<!-- comment -->
- Calculez les résultats pour plusieurs graines aléatoires différentes, puis afficher les taux d'erreur pour chaque graine sur le graphique d'aperçu des erreurs, et permettre à l'utilisateur de sélectionner n'importe lequel de ces résultats.
<!-- comment -->
- Calculez les résultats pour plusieurs nombres différents d'agrégations (K).
<!-- comment -->
...
<!-- comment -->
Ajoutez un graphique d'ensemble qui montre la valeur ARI de chaque modèle et permet de sélectionner le nombre d'agrégations.
<!-- comment -->
