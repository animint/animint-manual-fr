...
<!-- comment -->
- en les publiant sur [GitHub Pages](https://pages.github.com/) et comment les organiser dans une galerie.
...
En interne, R appelle la méthode S3 `print.animint`, laquelle appelle `animint2dir` afin de compiler la visualisation dans un nouveau dossier temporaire sur votre ordinateur personnel.
<!-- comment -->
