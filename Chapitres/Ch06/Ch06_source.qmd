...
Ce chapitre donne une liste complète des nouvelles fonctionnalités qu'`animint2` introduit dans la grammaire des graphiques (qui n'existe pas dans `ggplot2`).
<!-- comment -->
...
On peut rajouter un hyperlien avec `aes(href)`.
Par exemple, si nous avons une carte des États-Unis, on peut rajouter un lien vers le page Wikipédia de chaque état.
