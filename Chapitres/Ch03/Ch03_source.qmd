...
* Cliquer sur « Pause » pour arrêter l'animation.
* Cliquer sur « Play » pour rédemarrer l'animation.
* Pour contrôler le temps entre les mises à jour de la variable d'animation, taper un nombre (en millisecondes) dans le champs « updates » et ensuite taper la touche d'entrée.
