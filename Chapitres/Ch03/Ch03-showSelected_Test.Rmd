...
Some transitions result in points moving only a little bit, to nearby  positions (e.g.
...
Other transitions result in points moving  a lot more, to far away locations (e.g.
