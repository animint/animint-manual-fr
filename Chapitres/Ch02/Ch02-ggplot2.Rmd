...
Le jeu de données `BanqueMondiale` rassemble des indicateurs tels que le taux de fertilité et l'espérance de vie de chaque pays entre 1960 et 2010.
<!-- comment -->
...
<!-- comment -->
Plus particulièrement que les données de la plupart des pays se sont déplacées vers la droite et vers le bas, ce qui signifie une espérance de vie plus élevée et un taux de fertilité plus faible.
<!-- comment -->
