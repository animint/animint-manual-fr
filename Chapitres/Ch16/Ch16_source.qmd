...
Une partie importante du diagnostic consiste à détecter les "points de rupture" ou les changements abrupts au sein d'un chromosome donné (panneau).
<!-- comment -->
...
<!-- comment -->
La colonne `status` peut être utilisée pour afficher l'erreur d'étiquette : `false negative` pour trop peu de changements, `false positive` pour trop de changements, ou `correct` pour le bon nombre de modifications.
