...
Ci-dessus, nous voyons une ligne pour chaque combinaison de lieu et jour.
<!-- comment -->
...
<!-- comment -->
Notez que nous avons créé une colonne `mois.français` qui sera utilisé comme variable de sélection pour les mois.
<!-- comment -->
...
On remarque que certains mois contiennent des journées manquantes. Par exemple, il n'y a que 29 jours pour `Berri` en avril 2009, et 18 jours pour `Totem_Laurier` en septembre 2013.
<!-- comment -->
Pour modeliser seulement les mois entiers, nous voulons enlever les mois avec jours manquants.
<!-- comment -->
Alors on utilise le code ci-dessous pour calculer le nombre de jours dans chaque mois :
