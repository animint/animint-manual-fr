...
velo.counts <- table(passages_dt$location)
...
accidents.range <- accidents_dt[, data.table(
  location="accidents",
...
mois.text <- passages.par.mois[, .SD[which.max(passages_length)], by=location]
MonthFacet <- ggplot()+
