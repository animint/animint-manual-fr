...
<!-- comment -->
Le code dans ce chapitre est une version modifiée du code dans [ce blog](https://tdhock.github.io/blog/2025/mlr3torch-conv/), qui aborde la visualisation statique.
...
<!-- comment -->
Rémarqons que si on veut calculer l’AUC, il faut préciser `predict_type="prob"`, ce qui fait que la prédiction est un nombre réel (et non seulement la classe la plus probable).
