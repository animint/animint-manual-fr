...
- Les colonnes `round_*` sont arrondies à la taille de bac la plus proche (entière par défaut), et sevent à définir les positions `x` et `y` de la tuile de la carte thermique.
<!-- comment -->
