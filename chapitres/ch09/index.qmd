...
Dans ce chapitre, nous explorerons plusieurs visualisations pour un ensemble de données portant sur le vélo à Montréal.
...
Le graphique ci-dessus permet de distinguer facilement les zéros (en gris) et les valeurs manquantes.
...
Dans la sortie ci-dessus, on voit que les derniers mois pour les accidents ne sont pas les mêmes que pour les compteurs. Nous comparons les intervalles dans le code ci-dessous :
...
<!-- comment -->
Nous utilisons le code ci-dessous pour calculer le nombre de jours dans chaque mois :
...
<!-- comment -->
Avec le code ci-dessous, nous affichons seulement les mois avec des jours manquants :
...
<!-- comment -->
Nous utilisons le code ci-dessous pour établir une correspondance entre les tableaux :
...
### Résumé des dates de début et de fin pour chaque compteur
...
Dans la sortie ci-dessus, on voit une ligne par compteur, avec des colonnes pour les dates de début et de fin.
<!-- comment -->
...
Le graphique ci-dessus contient une ligne par compteur.
<!-- comment -->
...
<!-- comment -->
Ci-dessous, nous classons les accidents selon le degré de gravité pour les personnes touchées :
...
<!-- comment -->
- Sur le graphique `MonthSummary`, ajoutez des rectangles en arrière-plan pour sélectionner le mois.
<!-- comment -->
