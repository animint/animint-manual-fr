...
<!-- comment -->
- validation : utilisé pour éviter le surajustement.
<!-- comment -->
...
<!-- comment -->
Pour créer cette grille, nous créons d’abord une liste contenant les deux grilles 1D pour chaque caractéristique.
...
<!-- comment -->
Les calculs d’avance/valeur et de gradient reposent sur la multiplication matricielle.
<!-- comment -->
...
<!-- comment -->
Chacune d’elle est utilisée pour prédire les unités d’une couche donnée à partir des unités de la couche précédente.
<!-- comment -->
...
Le graphique ci-dessus montre les prédictions gagnent en précision à mesure que le nombre d’itérations augmente. 
<!-- comment -->
