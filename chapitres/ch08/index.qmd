...
Le code ci-dessus est un exemple de la méthode [rajouter une colonne et facettes](/ch99#addColumn-then-facet).
Notez que les niveaux des facteurs détermineront l’ordre des facettes dans l’affichage.
...
## Ajout d’une facette pour les séries temporelles {#add-ts}
...
Dans le [chapitre 9](/ch09) nous vous expliquerons comment visualiser les données sur les vélos à Montréal.
