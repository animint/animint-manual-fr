...
<!-- comment -->
Ceci est un exemple de la méthode [rajouter une colonne pour facettes](/ch99#addColumn-then-facet) .
<!-- comment -->
...
Nous définissons `panel.margin` à 0, ce qui est toujours une bonne idée pour [économiser de l'espace dans un ggplot avec des facettes](/ch99#space-saving-facets).
<!-- comment -->
Dans un des exemples tiré de, dans un exemple de la méthode [addColumn ensuite facettes](/ch99#addColumn-then-facet),  nous utilisons `scales="free"` et nous masquons les étiquettes des axes  .
<!-- comment -->
