...
![Visualisation des probabilités dans la régression de Poisson](ch13-viz-prob.png)
...
![Visualisation des probabilités cumulées dans la régression de Poisson](ch13-viz-cum-prob.png)

<!-- paragraph -->

Lorsque nous spécifions les ensembles de données, nous utilisons l'idiome [addColumn then facet](/ch99#addColumn-then-facet) pour ajouter une variable `panel`.
...
Dans le [chapitre 14](/ch14), nous vous expliquerons comment utiliser les `clickSelects/showSelected` explicites pour visualiser le modèle d'apprentissage automatique PeakSegJoint avec des variables de sélection basées sur les données.
