...
<!-- comment -->
Notez également que nous utilisons `color="red"` et `size=5` avec `geom_point()` afin de faciliter la visualisation des points sur un fond gris et le survol avec le curseur pour afficher l’infobulle.
<!-- comment -->
