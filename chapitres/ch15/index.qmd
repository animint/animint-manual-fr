...
<!-- comment -->
En fait, une solution faisant appel à la fonction W de Lambert existe [@Lambert_W_function].
L’objectif de ce chapitre est de créer une visualisation des données interactive qui explique la méthode de Newton pour trouver les racines de telles fonctions [@Newton].
...
<!-- comment -->
- Dérivez la fonction de perte pour la régression binomiale et visualisez la méthode de recherche de racines de Newton correspondante [@binomial].
<!-- comment -->
