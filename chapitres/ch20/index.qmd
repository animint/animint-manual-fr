...
Dans cette section, nous explorons la régularisation d’arrêt prématuré appliquée aux algoritmes d’apprentissage du package `torch`.
...
Dans le graphique ci-dessus, on bserve que :
...
<!-- comment -->
Nous pouvons alors utiliser l’échelle logarithmique pour visualiser la proximité de la courbe et de 0.
...
Le graphique ci-dessus révèle que le modèle lineaire risque le surapprentissage dans trois jeux de données (`sonar`, `vowel` et `waveform`) si le niveau de régularisation est trop faible.
