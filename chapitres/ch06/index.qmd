...
Notez que `viz.scale.size` possède déjà trois ggplots, chacun avec son `ggtitle`.
<!-- comment -->
Ajouter l’option globale `title` a pour effet de définir un titre pour [la page web](ch06-viz-title/index.html) .
