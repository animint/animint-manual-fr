...
- Utilisez [la mise en page d’un tableau HTML](../ch06/ch06-other#html-table-layout) pour [`vis.linear.svm`](#linear-svm) de manière à ce que les deux graphiques de l’espace des variables apparaissent l’un à côté de l’autre et que le graphique « Choisir la régularisation » apparaisse au-dessus ou en-dessous.
<!-- comment -->
